"""
Figure 3 — Random 30% Validation
  Fig3a: Bar chart (NSE & KGE, 8 methods)
  Fig3b: 8-method scatter panel (2×4)
"""
...
SUMMARY = ROOT / "04_Random_30pct_Validation" / "random_30pct_summary.csv"
...
DISPLAY_ORDER = ["MAML", "DTRR", "RandomForest", "Linear",
...
# ── Fig3a: Bar chart (same format as Fig6a) ───────────────────────────
...
fig_a.savefig(str(OUTDIR / "Fig3a_random_bar.png"), dpi=300, bbox_inches="tight", facecolor="white")
fig_a.savefig(str(OUTDIR / "Fig3a_random_bar.pdf"), bbox_inches="tight", facecolor="white")
plt.close(fig_a)
print("Saved Fig3a_random_bar")
...
fig_b.savefig(str(OUTDIR / "Fig3b_random_scatter.png"), dpi=300, bbox_inches="tight", facecolor="white")
fig_b.savefig(str(OUTDIR / "Fig3b_random_scatter.pdf"), bbox_inches="tight", facecolor="white")
plt.close(fig_b)
print("Saved Fig3b_random_scatter")
