...
SCRIPTS = [
    ...
    PROJECT_DIR / "02_Feature_Table" / "02_extract_hydro_features_global.py",
    ...
    PROJECT_DIR / "08_GSIM_PLUS_Product" / "08_build_gsim_plus_anchor_dataset.py",
]
...
def main():
    for script in SCRIPTS:
        print(f"\nRunning: {script.name}")
        result = subprocess.run([sys.executable, str(script)], cwd=str(PROJECT_DIR))
